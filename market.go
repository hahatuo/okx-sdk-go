...
func (s *MarketService) Tickers(ctx context.Context, req TickersRequest) ([]Ticker, error) {
	...
	return executeGet[Ticker](ctx, s.c, "/api/v5/market/tickers", q, "public:market:tickers", false)
}
...
func (s *MarketService) Ticker(ctx context.Context, req TickerRequest) ([]Ticker, error) {
	...
	return executeGet[Ticker](ctx, s.c, "/api/v5/market/ticker", q, "public:market:ticker:"+req.InstID, false)
}
...
func (s *MarketService) OrderBook(ctx context.Context, req OrderBookRequest) ([]OrderBook, error) {
	...
	return executeGet[OrderBook](ctx, s.c, "/api/v5/market/books", q, "public:market:books:"+req.InstID, false)
}
...
func (s *MarketService) Trades(ctx context.Context, req TradesRequest) ([]MarketTrade, error) {
	...
	return executeGet[MarketTrade](ctx, s.c, "/api/v5/market/trades", q, "public:market:trades:"+req.InstID, false)
}
...
func (s *MarketService) HistoryTrades(ctx context.Context, req HistoryTradesRequest) ([]MarketTrade, error) {
	...
	return executeGet[MarketTrade](ctx, s.c, "/api/v5/market/history-trades", q, "public:market:history-trades:"+req.InstID, false)
}
...
func (s *MarketService) IndexCandles(ctx context.Context, req CandlesRequest) ([]Candle, error) {
	return s.candlesEndpoint(ctx, req, "/api/v5/market/index-candles", "public:market:index-candles:")
}
...
func (s *MarketService) HistoryIndexCandles(ctx context.Context, req CandlesRequest) ([]Candle, error) {
	return s.candlesEndpoint(ctx, req, "/api/v5/market/history-index-candles", "public:market:history-index-candles:")
}
...
func (s *MarketService) MarkPriceCandles(ctx context.Context, req CandlesRequest) ([]Candle, error) {
	return s.candlesEndpoint(ctx, req, "/api/v5/market/mark-price-candles", "public:market:mark-price-candles:")
}
...
func (s *MarketService) HistoryMarkPriceCandles(ctx context.Context, req CandlesRequest) ([]Candle, error) {
	return s.candlesEndpoint(ctx, req, "/api/v5/market/history-mark-price-candles", "public:market:history-mark-price-candles:")
}

func (s *MarketService) candles(ctx context.Context, req CandlesRequest) ([]Candle, error) {
	path := "/api/v5/market/candles"
	rateKeyPrefix := "public:market:candles:"
	if req.History {
		path = "/api/v5/market/history-candles"
		rateKeyPrefix = "public:market:history-candles:"
	}
	return s.candlesEndpoint(ctx, req, path, rateKeyPrefix)
}

func (s *MarketService) candlesEndpoint(ctx context.Context, req CandlesRequest, path, rateKeyPrefix string) ([]Candle, error) {
	if req.InstID == "" {
		return nil, required("instId")
	}
	q := url.Values{"instId": {req.InstID}}
	...
	return executeGet[Candle](ctx, s.c, path, q, rateKeyPrefix+req.InstID, false)
}
...
func (s *MarketService) Platform24Volume(ctx context.Context) ([]Platform24Volume, error) {
	return executeGet[Platform24Volume](ctx, s.c, "/api/v5/market/platform-24-volume", nil, "public:market:platform-24-volume", false)
}
