...
func (s *TradeService) PlaceMultipleOrders(ctx context.Context, req []PlaceOrderRequest) ([]OrderAck, error) {
	return executeMultipleTradeOrders(ctx, s, req, "/api/v5/trade/batch-orders", "private:trade:batch-orders", validatePlaceOrder)
}
...
func (s *TradeService) CancelOrder(ctx context.Context, req CancelOrderRequest) ([]OrderAck, error) {
	return executeTradeOrder(ctx, s, req, "/api/v5/trade/cancel-order", "private:trade:cancel-order:"+req.InstID, validateCancelOrder)
}
...
func (s *TradeService) CancelMultipleOrders(ctx context.Context, req []CancelOrderRequest) ([]OrderAck, error) {
	return executeMultipleTradeOrders(ctx, s, req, "/api/v5/trade/cancel-batch-orders", "private:trade:cancel-batch-orders", validateCancelOrder)
}
...
func (s *TradeService) AmendOrder(ctx context.Context, req AmendOrderRequest) ([]OrderAck, error) {
	return executeTradeOrder(ctx, s, req, "/api/v5/trade/amend-order", "private:trade:amend-order:"+req.InstID, validateAmendOrder)
}
...
func (s *TradeService) AmendMultipleOrders(ctx context.Context, req []AmendOrderRequest) ([]OrderAck, error) {
	return executeMultipleTradeOrders(ctx, s, req, "/api/v5/trade/amend-batch-orders", "private:trade:amend-batch-orders", validateAmendOrder)
}

func executeMultipleTradeOrders[T any](ctx context.Context, s *TradeService, req []T, path string, rateKey string, validate func(T) error) ([]OrderAck, error) {
	if len(req) == 0 {
...
func executeTradeOrder[T any](ctx context.Context, s *TradeService, req T, path string, rateKey string, validate func(T) error) ([]OrderAck, error) {
...
func (s *TradeService) Order(ctx context.Context, req OrderRequest) ([]Order, error) {
	...
	err := s.c.do(ctx, requestSpec{
		...
		query:   q,
		auth:    true,
		rateKey: "private:trade:order-query:" + req.InstID,
	}, &out)
	return out, err
}
